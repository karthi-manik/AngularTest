...
public class DeleteUser_And_ValidateOnTable {
    ...
    public void main() throws Exception {
        ...
        try{
            ...
            DelUser.fnDelUser(iTestCaseRow);
            ExtentTestManager.getTest().log(Status.PASS, "Delete User is successfully done and validated");
